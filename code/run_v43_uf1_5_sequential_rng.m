% Test PlatEMO v4.3 with one default RNG stream across 30 sequential runs.
...
outRoot = fullfile(scriptDir,'nsga2_outputs','platemo_v43_uf1_5_sequential_rng');
