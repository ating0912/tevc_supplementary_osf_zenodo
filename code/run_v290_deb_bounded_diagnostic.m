% Isolate Deb C bounded SBX, mutation order, and tournament interaction.

clear; clc;

root = fileparts(mfilename('fullpath'));
outputRoot = fullfile(root,'nsga2_outputs','v290_deb_bounded_diagnostic');
...
variants = {
    'B1_platemo_native',             @NSGAII;
    'B2_deb_bounded_plat_mutation',  @NSGAII_DebBoundedPlatMutation_v290;
    'B3_deb_bounded_deb_mutation',   @NSGAII_DebBoundedDebMutation_v290;
    'B4_deb_bounded_full_selection', @NSGAII_DebBoundedFullSelection_v290;
};
